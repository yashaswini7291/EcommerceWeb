...
func EditAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		update := bson.D{{Key: "$set", Value: bson.D{primitive.E{Key: "address.0.house_name", Value: editaddress.House}, {Key: "address.0.street_name", Value: editaddress.Street}, {Key: "address.0.city_name", Value: editaddress.City}}}}
...
func DeleteAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.IndentedJSON(404, "Action failed:(")
		}
